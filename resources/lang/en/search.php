...
return [
    ...
    */
    ...
    'found_toponyms' => '{0} There are no toponyms.|{1} <span class="important big">:count</span> toponym was found.|[2,Inf] <span class="important big">:count</span> toponyms were found.',
