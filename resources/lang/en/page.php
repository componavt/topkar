...
return [
    ...
    |
    */
    'award_heritage' => '<p>The TopKar – Toponymy of Karelia geoinformation system was awarded the Nasledie (Heritage) Prize in the category Best Research Project. The prize is established by the ANO Center for Arctic Initiatives and supports projects aimed at the preservation and development of indigenous languages of the Russian North. The competition, launched in May 2025, received over 60 applications; winners were honoured at the Festival of Languages of the Peoples of the North.</p>',
    ...
    'welcome_text_content'  => 'The TopKar resource (Toponymy of Karelia) allows you to save, systematize and explore '
        ...
        . 'Each name is linked to the location of named natural objects — region, district and settlement. '
