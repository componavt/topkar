...
class District1926Controller extends Controller
{
    ...
    public function __construct(Request $request)
    {
        $this->middleware(
            'is_editor',
            ['except' => ['index', 'district1926List', 'show']]
        );
    ...
    public function simpleStore(Request $request)
    {
        ...
        return Response::json([
            ...
            'region_name' => $district->region->{$field}
        ]);
    }
        ...
        if ($id != "" && $id > 0) {
            try {
                ...
                if ($district1926) {
                    ...
                    $district1926->delete();
                    $result['message'] = trans('toponym.district_removed', ['name' => $district1926_name]);
                } else {
                    $error = true;
