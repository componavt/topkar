...
class ToponymController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            ...
            compact(
                'district_values',
                'district1926_values',
                'ethnos_territory_values',
                'etymology_nation_values',
                'geotype_values',
                'informant_values',
                'recorder_values',
                'region_values',
    ...
    public function duplicates(Request $request)
    {
        ...
        $group_by_fields = collect([
            'district_id' => 'Современный район',
    ...
    {
        $portion = 100;
        $items = Toponym::lastCreated($portion)
        ...
        return view('dict.toponyms.last_created', compact('items'));
    }

    public function lastUpdated()
    {
        $portion = 100;
        $items = Toponym::lastUpdated($portion, 1);

        if (!$items) {
            return Redirect::to('/');
        }
        return view('dict.toponyms.last_updated', compact('items'));
    }
