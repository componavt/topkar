...
CREATE TABLE IF NOT EXISTS `geotype_category` (
  ...
  `category_id` TINYINT UNSIGNED NOT NULL COMMENT 'id',
  PRIMARY KEY (`id`),
  INDEX `type_category_idx` (`type_id` ASC, `category_id` ASC),
  INDEX `fk_geocategory_id_idx` (`category_id` ASC),
...
CREATE TABLE IF NOT EXISTS `structs` (
  ...
  `text` VARCHAR(150) NOT NULL COMMENT 'structure name',
